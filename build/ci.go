...
import (
	...
	"github.com/meta-chain/go-ethereum-arbitrum/crypto/signify"
	"github.com/meta-chain/go-ethereum-arbitrum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/meta-chain/go-ethereum-arbitrum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/meta-chain/go-ethereum-arbitrum/internal/version.gitDate="+env.Date)
	}
